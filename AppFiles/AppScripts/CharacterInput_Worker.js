...
function recognizeCharacter(activeCellIDsArray) {
    ...
    var characterDatabaseMultiArray = [
        //A
    ...
    var characterDatabaseMultiArrayLength = characterDatabaseMultiArray.length;
    for (var i = 0; i < characterDatabaseMultiArrayLength; i++) {
        //Declare intersectionArray
        var intersectionArray = [];
        //Get the intersection Array
        var activeCellIDsArrayLength = activeCellIDsArray.length;
        for (var j = 0; j < activeCellIDsArrayLength; j++) {
        ...
        var score = (intersectionArray.length / characterDatabaseMultiArray[i][0].length) + (intersectionArray.length / activeCellIDsArrayLength);
